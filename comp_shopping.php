...
<?php
	...
	if(@isset($_GET['add']))
	{
		...
		<br>
		<div class="container">
		<?echo '<a class="btn btn-success" href="index2.php">Continue Shopping</a>';
					...
					while($get_row=mysql_fetch_assoc($get))
					{
						...
						//echo '<b>'.$get_row['name'].'</b> x '.$value.' @  &#8377;'.number_format($get_row['price']).' = &#8377;'.number_format($sub).'<a href="shopping.php?remove='.$id.'"> [-] </a> <a href="shopping.php?add='.$id.'"> [+] </a> <a href="shopping.php?delete='.$id.'"> Delete </a><br/>';?>
								...
								<tr>
									...
									<td><? echo '<a href="comp_shopping.php?remove='.$id.'"> [-] </a> <a href="comp_shopping.php?add='.$id.'"> [+] </a> <a href="comp_shopping.php?delete='.$id.'"> Delete </a><br/>';?></td>
								</tr>
					<?}
				}
				$total += $sub;
