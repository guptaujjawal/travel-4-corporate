			...
			<div class="container">
				...
				<div class="collapse navbar-collapse navHeaderCollapse">
					<ul class="nav navbar-nav navbar-right">
						<li class="active"><a href="http://localhost/minor/index2.php">Home</a></li>
						<li class="dropdown">
						...
						<li><a href="http://localhost/minor/comp_reqform.php">Requistion Form </a></li>
